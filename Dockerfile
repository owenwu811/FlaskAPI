...
EXPOSE 5000                                       #container listens on port 5,000 to map container port to host. 
...
RUN pip install -r requirements.txt               #pip inside container to install app dependencies specified in requirements.txt
